namespace Radical.Series.Spectrum
{
    ...
    public class SpectrumScopeValue : SpectrumBase
    {
        ...
        public SpectrumScopeValue(
            int Size,
            ISeries<SpectrumBase> Scopes,
            ISeries<SpectrumBase> SigmaScopes,
            ...
            if (size != MINIMUM_UNIVERSE_SIZE_U4)
            {
                ...
                if (!scopes.TryGet(scopesKey, out scopesItem))
                {
                    if (parentSqrt == MINIMUM_UNIVERSE_SIZE_U4)
                    {
                        if (sigmaNode == null)
                        {
                            sigmaNode = new SpectrumTetraValue(-1);
                        ...
                        scopesItem = new SpectrumTetraValue(-1);
                    ...
                    else
                    {
                        if (sigmaNode == null)
                        {
                            sigmaNode = new SpectrumScopeValue(
                                parentSqrt,
                                scopes,
                                sigmaScopes,
                                levels,
                        ...
                        scopesItem = new SpectrumScopeValue(
                            parentSqrt,
                            scopes,
                            sigmaScopes,
                            levels,
            ...
            if (size != MINIMUM_UNIVERSE_SIZE_U4)
            {
                ...
                if (!sigmaScopes.TryGet(sigmaScopesKey, out sigmaScopesItem))
                {
                    if (parentSqrt == MINIMUM_UNIVERSE_SIZE_U4)
                    {
                        ...
                        sigmaScopesItem = new SpectrumTetraValue(-1);
                    ...
                    else
                    {
                        ...
                        sigmaScopesItem = new SpectrumScopeValue(
                            parentSqrt,
                            scopes,
                            sigmaScopes,
                            levels,
