namespace Radical.Ethernet.Formatters.Json
{
    ...
    public class JsonParser
    {
        ...
        )
        {
            ...
            {
                var bag = GetBagForObject(element.GetType(), element, complexity);
                SerializeItem(sb, bag, null, complexity);
            }
            else
            {
                ICollection array = (ICollection)element;
                ...
                {
                    SerializeItem(sb, item, null, complexity);
                    count++;
                    if (count < total)
                        sb.Append(",");
                }
