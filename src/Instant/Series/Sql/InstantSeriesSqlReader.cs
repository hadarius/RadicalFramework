namespace Radical.Instant.Series.Sql
{
    ...
    public class InstantSeriesSqlReader : IDataReader
    {
        ...
        public InstantSeriesSqlReader(IInstantSeries resultset)
        {
        ...
        public InstantSeriesSqlReader(InstantSeriesItem[] resultset)
        {
