...
{
    public struct ArrayStockSpan : IList, ICollection
    {
        private readonly IList _list;
        private readonly int _offset;
        private readonly int _count;

        public ArrayStockSpan(IList list)
        {
            if (list == null)
        ...
        public ArrayStockSpan(IList list, int offset, int count)
        {
            if (list == null)
                throw new ArgumentNullException("vector");
            if (offset < 0)
        ...
        {
            if (obj is ArrayStockSpan)
                return Equals((ArrayStockSpan)obj);
            else
                return false;
        }

        public bool Equals(ArrayStockSpan obj)
        {
            return obj._list == _list && obj._offset == _offset && obj._count == _count;
        }

        public static bool operator ==(ArrayStockSpan a, ArrayStockSpan b)
        {
            return a.Equals(b);
        }
        ...
        private sealed class ArraySliceEnumerator : IEnumerator
        {
            ...
            internal ArraySliceEnumerator(ArrayStockSpan arraySlice)
            {
