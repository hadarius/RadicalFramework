...
{
    using Radical.Instant.Series.Math.Set;
    using System;
    ...
    [Serializable]
    public class InstantSeriesMathCompilerContext
    {
        [NonSerialized]
        ...
        public InstantSeriesMathCompilerContext()
        {
        ...
        public void GenerateLocalInit(ILGenerator g)
        {
            ...
            for (int i = 0; i < paramCount; i++)
            {
                ...
                g.Emit(OpCodes.Ldfld, typeof(CompiledMathSet).GetField(paramFieldName));
